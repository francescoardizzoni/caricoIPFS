...
declare type EmittedEvents = RoomEvent | ThreadEvent.New | ThreadEvent.Update | RoomEvent.Timeline | RoomEvent.TimelineReset;
...
export declare class Room extends TypedEventEmitter<EmittedEvents, RoomEventHandlerMap> {
     ...
     */
    getOrCreateFilteredTimelineSet(filter: Filter, { prepopulateTimeline, pendingEvents, }?: ICreateFilterOpts): EventTimelineSet;
     ...
     * @experimental
     */
    addThreadedEvent(event: MatrixEvent, toStartOfTimeline: boolean): Promise<void>;
    createThread(rootEvent: MatrixEvent | undefined, events: MatrixEvent[], toStartOfTimeline: boolean): Thread | undefined;
    ...
    getReadReceiptForUserId(userId: string, ignoreSynthesized?: boolean): IWrappedReceipt | null;
    /**

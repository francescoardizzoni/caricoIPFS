...
class Room extends _typedEventEmitter.TypedEventEmitter {
  ...
  async createThreadTimelineSet(filterType) {
    ...
    if (_thread.Thread.hasServerSideSupport) {
      ...
      timelineSet.getLiveTimeline().setPaginationToken("", _eventTimeline.EventTimeline.BACKWARDS);
    } else {
  ...
  async addThreadedEvent(event, toStartOfTimeline) {
  ...
  createThread(rootEvent, events = [], toStartOfTimeline) {
    ...
    if (thread.id) {
      ...
      this.reEmitter.reEmit(thread, [_thread.ThreadEvent.Update, RoomEvent.Timeline, RoomEvent.TimelineReset]);

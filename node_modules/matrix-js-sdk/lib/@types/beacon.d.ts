 ...
 */
export declare const M_BEACON_INFO_VARIABLE: UnstableValue<"m.beacon_info.*", "org.matrix.msc3489.beacon_info.*">;
/**
 * Non-variable type for m.beacon_info event content
 */
export declare const M_BEACON_INFO: UnstableValue<"m.beacon_info", "org.matrix.msc3489.beacon_info">;
export declare const M_BEACON: UnstableValue<"m.beacon", "org.matrix.msc3489.beacon">;
export declare type MBeaconInfoContent = {
    description?: string;
    timeout: number;
    live?: boolean;
};
export declare type MBeaconInfoEvent = EitherAnd<{
 ...
 */
export declare type MBeaconInfoEventContent = MBeaconInfoEvent & MTimestampEvent & MAssetEvent;
/**

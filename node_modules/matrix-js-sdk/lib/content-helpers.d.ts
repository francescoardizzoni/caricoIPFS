...
import { LocationAssetType, LocationEventWireContent, MLocationEventContent, LegacyLocationEventContent } from "./@types/location";
/**
...
export declare type MakeBeaconContent = (uri: string, timestamp: number, beaconInfoId: string, description?: string) => MBeaconEventContent;

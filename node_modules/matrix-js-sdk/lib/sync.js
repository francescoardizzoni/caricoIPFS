...
class SyncApi {
  ...
  createGroup(groupId) {
    ...
    client.reEmitter.reEmit(group, [_client.ClientEvent.GroupProfile, _client.ClientEvent.GroupMyMembership]);
  ...
  registerStateListeners(room) {
    ...
    client.reEmitter.reEmit(room.currentState, [_roomState.RoomStateEvent.Events, _roomState.RoomStateEvent.Members, _roomState.RoomStateEvent.NewMember, _roomState.RoomStateEvent.Update, _beacon.BeaconEvent.New, _beacon.BeaconEvent.Update, _beacon.BeaconEvent.LivenessChange]);
  ...
  async processSyncResponse(syncEventData, data) {
    ...
    await utils.promiseMapSeries(joinRooms, async joinObj => {
      ...
      await this.processThreadEvents(room, threadedEvents, false); // set summary after processing events,
  ...
  processGroupSyncEntry(groupsSection, sectionName) {
    ...
    for (const groupId of Object.keys(groupsSection)) {
      ...
      if (isBrandNew) {
        ...
        this.client.emit(_client.ClientEvent.Group, group);
      }
    }
  }
  /**
